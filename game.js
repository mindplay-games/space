...
const chapters = {
  ...
  1: [
    ...
    // סצנה 6 – סיום תיקון חדר הבקרה
    {
      ...
      avatar: "assets/characters/ai-orion.png",
      text:
        "עבודה מדהימה, צוות! הפעלתם את חדר הבקרה. עכשיו אפשר לצאת אל המסע הבין־כוכבי. היעד הבא במפת הגלקסיה: כוכב התקשורת!"
    },
...
2: [
  // 🎬 סרטון פתיחה – הגעה לכוכב התקשורת (אופציונלי)
  {
    type: "video",
    icon: "🎬",
  ...
  // 🌌 פתיחת סיפור
  {
    ...
    bg: "assets/backgrounds/ch3-communication-planet.png",
    story:
      "מסביבכם אנטנות ענק מסתובבות ואורות מהבהבים. הכוכב מסוגל לתקשר עם כל הגלקסיה — אם מזינים את המידע הנכון.",
    character: "מיינדפלי הרובוט",
    avatar: "assets/characters/ai-orion.png",
    text:
      "ברוכים הבאים לכוכב התקשורת! כאן לא מספיק רק להדפיס... צריך גם לקלוט מידע מהטייס/ת בעזרת input().",
    effect: "light"
  },

  // 🧩 משימה 1 – CODE (input + print)
  {
    type: "code",
    icon: "⌨️",
    bg: "assets/backgrounds/ch3-communication-planet.png",
    story:
      "האנטנה הראשית כבויה. היא תידלק רק אם נקבל שם מהטייס/ת ונשלח ברכת שלום.",
    character: "מיינדפלי הרובוט",
    text:
      "בקשו את השם של הטייס/ת עם input(), ואז הדפיסו ברכה עם השם.",
    prompt:
      'כתבו קוד שמבקש שם ושולח ברכה בדיוק כך:\nname = input("איך קוראים לך, טייס/ת? ")\nprint("ברוך הבא לכוכב התקשורת,", name, "!")',
    hint:
      'שימו לב לגרשיים, פסיק אחרי הטקסט, וגם סימן קריאה "!".',
    validator: {
      mode: "contains",
      patterns: [
        'name=input("איךקוראיםלך,טייס/ת?")',
        'print("ברוךבאלכוכבהתקשורת,",name,"!")'
      ]
    },
    effect: "engine",
    successText: "✅ האנטנה הראשית נדלקה! השידור הראשון נקלט."
  },
  ...
  // 🟦 משימה 2 – MCQ
  {
    ...
    bg: "assets/backgrounds/ch3-communication-planet.png",
    story:
      "שלוש אנטנות מנסות לקלוט מידע. רק אחת באמת משתמשת ב-input() נכון.",
    character: "מיינדפלי הרובוט",
    text:
  ...
  // 🟪 משימה 3 – DRAG (סדר נכון)
  {
    type: "drag",
    icon: "🧩",
    bg: "assets/backgrounds/ch3-communication-planet.png",
    story:
      "חלקי השידור התפזרו בין תחנות הממסר. צריך להרכיב את הסדר הנכון כדי שהשידור יעבוד.",
    character: "מיינדפלי הרובוט",
    text:
      "קודם קולטים מידע עם input(), ואז משתמשים בו ב-print().",
    prompt:
      'גררו את החלקים לסדר הנכון כדי ליצור שידור תקין:',
    items: [
      '📡 שידור מוכן',
      'print("שלום", name)',
      'name = input("מה שמך? ")'
  ...
  // 🌌 סיום פרק 3
  {
    ...
    bg: "assets/backgrounds/ch3-communication-planet.png",
    story:
      "הכוכב כולו זוהר. אנטנות ענק משדרות את השם שלכם אל תוך החלל.",
    character: "מיינדפלי הרובוט",
    avatar: "assets/characters/ai-orion.png",
    text:
