...
2: [
  ...
  // 🌌 פתיחת סיפור
  {
    ...
    avatar: "assets/characters/ai-orion.png",
    text:
      "האנטנה הראשית כבויה ותידלק רק עם נקלוט את השם של המפעילה של האנטנה -בפייתון קולטים מידע למערכת בעזרת פקודת ()input ",
    effect: "light"
  },
  ...
  // 🧩 משימה 1 – CODE (input + print)
  {
    ...
    bg: "assets/backgrounds/ch3-communication-planet.png",
    story:
      "האנטנה הראשית כבויה. היא תידלק רק אם נקלוט שם מהמפעילה שלה, ונשלח ברכת שלום.",
    character: "מיינדפלי הרובוט",
    text:
      " בקשו את השם של המפעילה עם פקודת ()input",
    prompt:
      ' אינפוט מאפשרת לנו גם להדפיס הוראה של מה אנחנו מבקשים לקלוט input("your name?")',
    hint:
      'input("your name?")',
    validator: {
      mode: "exact",
